...
public class testAMS_Reminder_Modify extends API {
    ...
    public void testModify() throws IOException {
        ...
        ArrayList actual = AMS.Request(mac, Operation.modify, count_reminders,
                ...
                reminderProgramId, 0, reminderScheduleId, reminderId);
    ...
    @Test
    public void testModify_mac_empty() throws IOException {
    ...
    @Test
    public void testModify_mac_wrong() throws IOException {
        ArrayList actual = AMS.Request(mac_wrong, Operation.modify, count_reminders,
                reminderProgramStart(), reminderChannelNumber, reminderProgramId,
                reminderOffset, reminderScheduleId, reminderId);
    ...
    public void testModify_count_reminders_is_0() throws IOException {
        ArrayList actual = AMS.Request(mac, Operation.modify, 0,
                reminderProgramStart(), reminderChannelNumber, reminderProgramId,
                reminderOffset, reminderScheduleId, reminderId);
        assertEquals(expected400, actual.get(0));
    ...
    public void testModify_all_wrong() throws IOException {
        ArrayList actual = AMS.Request(mac_wrong, Operation.modify, 0,
