...
public class testAMS_Reminder_Add extends API {
    ...
    public void testAdd_reminderChannelNumber_empty__statusCode3() throws IOException {
        ArrayList actual = AMS.Request(mac, Operation.add, count_reminders,
                reminderProgramStart(), reminderChannelNumber_empty, reminderProgramId, reminderOffset, reminderScheduleId(), reminderId());
        assertEquals(expected200, actual.get(0));
    ...
    public void testAdd_statusCode5() throws IOException {
        ...
        actual = AMS.Request(mac, Operation.add, count_reminders, reminderProgramStart(), reminderChannelNumber, reminderProgramId,
    ...
    public void testAdd__REM_002_Reminders_Service_error_Can_not_connect_to_STB_with_stbId() throws IOException {
        ArrayList actual = AMS.Request(mac, Operation.add, count_reminders,
                ...
                reminderOffset, reminderScheduleId(), reminderId());
        assertEquals(expected500, actual.get(0));
        assertEquals("REM-002 Reminders Service error: Can not connect to STB with stbId=" + mac, actual.get(1));
    }

    @Test
    public void testAdd_mac_empty() throws IOException {
    ...
    @Test
    public void testAdd_mac_wrong() throws IOException {
        ArrayList actual = AMS.Request(mac_wrong, Operation.add, count_reminders,
                reminderProgramStart(), reminderChannelNumber, reminderProgramId,
                reminderOffset, reminderScheduleId(), reminderId());
        assertEquals(expected500, actual.get(0));
    ...
    public void testAdd_count_reminders_is_0() throws IOException {
        ArrayList actual = AMS.Request(mac, Operation.add, 0,
                reminderProgramStart(), reminderChannelNumber, reminderProgramId,
                reminderOffset, reminderScheduleId(), reminderId());
        assertEquals(expected400, actual.get(0));
