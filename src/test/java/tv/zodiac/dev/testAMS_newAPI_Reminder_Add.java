 ...
 */
class testAMS_newAPI_Reminder_Add extends API {
    ...
    void testAdd_reminderChannelNumber_0__statusCode3() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, 0, reminderProgramId, reminderOffset, reminderScheduleId, reminderId);
        assertEquals(expected200, actual.get(0));
    ...
    void testAdd_reminderChannelNumber_empty() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, -1, reminderProgramId, reminderOffset, reminderScheduleId, reminderId);
    ...
    void testAdd_reminderChannelNumber_LONG_MAX_VALUE() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, Long.MAX_VALUE, reminderProgramId, reminderOffset, reminderScheduleId, reminderId);
        assertEquals(expected500, actual.get(0));
        assertEquals("name cannot be null", actual.get(1));
    }
    ...
    void testAdd_reminderId_MIN_VALUE() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, reminderChannelNumber, reminderProgramId, reminderOffset, reminderScheduleId, Long.MIN_VALUE);
        assertEquals(expected400, actual.get(0));
    ...
    void testAdd_reminderOffset_empty() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, reminderChannelNumber, reminderProgramId, -1, reminderScheduleId, reminderId);
        assertEquals(expected500, actual.get(0));
        assertEquals("name cannot be null", actual.get(1));
    }
    ...
    void testAdd_reminderOffset_LONG_MAX_VALUE() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, reminderChannelNumber, reminderProgramId, Long.MAX_VALUE, reminderScheduleId, reminderId);
        assertEquals(expected500, actual.get(0));
        assertEquals("name cannot be null", actual.get(1));
    }
    ...
    void testAdd_reminderOffset_wrong() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, reminderChannelNumber, reminderProgramId, -2, reminderScheduleId, reminderId);
        assertEquals(expected400, actual.get(0));
    ...
    void testAdd_reminderProgramStart_PAST__statusCode2() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, "2000-01-01", reminderChannelNumber, reminderProgramId, reminderOffset, reminderScheduleId, reminderId);
        assertEquals(expected200, actual.get(0));
    ...
    void testAdd_reminderScheduleId_0_reminderId_0__statusCode4() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, reminderChannelNumber, reminderProgramId, reminderOffset, 0, 0);
        //discussed with Natalia Tarabutina:
        assertEquals(expected200, actual.get(0));
    ...
    void testAdd_reminderScheduleId_empty() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, reminderChannelNumber, reminderProgramId, reminderOffset, -1, reminderId);
        assertEquals(expected500, actual.get(0));
        assertEquals("name cannot be null", actual.get(1));
    }
    ...
    void testAdd_reminderScheduleId_empty_reminderId_empty() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, reminderChannelNumber, reminderProgramId, reminderOffset, -1, -1);
        assertEquals(expected500, actual.get(0));
        assertEquals("name cannot be null", actual.get(1));
    }
    ...
    void testAdd_reminderScheduleId_MAX_VALUE_reminderId_MAX_VALUE() throws IOException {
        ...
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, reminderChannelNumber, reminderProgramId, reminderOffset, Long.MAX_VALUE, Long.MAX_VALUE);
        assertEquals(expected200, actual.get(0));
        assertEquals("", actual.get(1));
        testPurge();
    }
    ...
    void testAdd_reminderScheduleId_MIN_VALUE_reminderId_MIN_VALUE() throws IOException {
        ArrayList actual = AMS.request(mac, Operation.add, count_reminders, reminderProgramStart, reminderChannelNumber, reminderProgramId, reminderOffset, Long.MIN_VALUE, Long.MIN_VALUE);
        assertEquals(expected400, actual.get(0));
        assertEquals("REM-008 Reminders parsing error: incorrect reminderScheduleId", actual.get(1));
    }
