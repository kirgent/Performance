...
/*      http.setHeader("Accept", "application/json");
    ...
    void Add(String macaddress, int count_reminders, int reminderOffset) throws IOException, InterruptedException {
        ...
        //String json_add5="{"deviceId":"A0722CB1AF24","reminders":["{"operation":"Add", "reminderChannelNumber":2, "reminderProgramStart":"2018-06-06 00:00", "reminderProgramId":0, "reminderOffset":0},"]}";
...
/*        Gson g = new Gson();
        ...
        for (Reminder rem : reminder.reminders) {
            for (Reminders rems : reminder) {
                System.out.println("[DBG] reminders: devideId=" + reminder.deviceId.length());
            }
        }*/
/*                    +reminder.reminders.operation
                    +"reminderChannelNumber"+ reminder.reminders.reminderChannelNumber
                    +"reminderProgramStart"+ reminder.reminders.reminderProgramStart
                    +"reminderProgramId"+ reminder.reminders.reminderProgramId
                    +"reminderOffset"+ reminder.reminders.reminderOffset);*/
    }
